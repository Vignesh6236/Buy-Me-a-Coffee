...
const Login = () => {
    return (
        <div className="w-screen">
            <div className="text-white w-screen py-14 container mx-auto">
                <h2 className="text-2xl font-bold text-center">
                    Login to allow your fans to support you!
                </h2>
            </div>
            <div className="social-buttons">
                <div className="flex flex-col gap-2  p-10 items-center">
                    ...
                    <button
                        ...
                        className="flex items-center w-80 bg-white border border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium text-gray-800 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500"
                    >
                        <svg
                            className="h-6 w-6 mr-2"
                            xmlns="http://www.w3.org/2000/svg"
